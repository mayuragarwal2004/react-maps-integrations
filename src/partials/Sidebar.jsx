...
import UserAvatar from "../images/LogiLink1.png";
    ...
    <div className="min-w-fit">
      ...
      >
        ...
        <div className="flex justify-between mb-10 pr-3 sm:px-2">
          ...
          {/* Logo */}
          <img src={UserAvatar} alt="logo" style={{ height: "50px" }}></img>
        </div>
            ...
            <ul className="mt-3">
              ...
              <SidebarLinkGroup
                activecondition={
                  ...
                  pathname.includes("SalesAnalytics") ||
                  pathname.includes("nodewiseanalysis") ||
                  pathname.includes("salesMap")
                }
              >
                {(handleClick, open) => {
                  return (
              ...
              <SidebarLinkGroup
                activecondition={
                  ...
                  pathname.includes("cargoanalysis") ||
                  pathname.includes("ordersanalysis")
                }
              >
                {(handleClick, open) => {
                  return (
              ...
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <ul className={`pl-8 mt-1 ${!open && "hidden"}`}></ul>
                      </div>
                    </React.Fragment>
                  );
                }}
